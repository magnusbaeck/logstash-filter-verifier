...
type ExecuteTestRequest struct {
	...
	SessionID  string            `protobuf:"bytes,1,opt,name=sessionID,proto3" json:"sessionID,omitempty"`
	InputLines []string          `protobuf:"bytes,2,rep,name=inputLines,proto3" json:"inputLines,omitempty"`
...
func (x *ExecuteTestRequest) GetFields() map[string]string {
	if x != nil {
		return x.Fields
	}
	return nil
...
var file_api_proto_rawDesc = []byte{
	...
	0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x0a, 0x69, 0x6e, 0x70, 0x75, 0x74, 0x4c, 0x69, 0x6e, 0x65, 0x73,
	0x12, 0x3c, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x24, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x65, 0x54,
	0x65, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x2f, 0x0a, 0x13, 0x45, 0x78, 0x65,
...
var file_api_proto_goTypes = []interface{}{
	...
	nil,                          // 8: grpc.ExecuteTestRequest.FieldsEntry
}
var file_api_proto_depIdxs = []int32{
	8, // 0: grpc.ExecuteTestRequest.fields:type_name -> grpc.ExecuteTestRequest.FieldsEntry
	0, // 1: grpc.Control.Shutdown:input_type -> grpc.ShutdownRequest
	2, // 2: grpc.Control.SetupTest:input_type -> grpc.SetupTestRequest
	4, // 3: grpc.Control.ExecuteTest:input_type -> grpc.ExecuteTestRequest
	6, // 4: grpc.Control.TeardownTest:input_type -> grpc.TeardownTestRequest
	1, // 5: grpc.Control.Shutdown:output_type -> grpc.ShutdownResponse
	3, // 6: grpc.Control.SetupTest:output_type -> grpc.SetupTestResponse
	5, // 7: grpc.Control.ExecuteTest:output_type -> grpc.ExecuteTestResponse
	7, // 8: grpc.Control.TeardownTest:output_type -> grpc.TeardownTestResponse
